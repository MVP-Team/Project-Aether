...
namespace Aether_Console.Terminal
{
    partial class Basis
    {
        ...
        public static async Task<string> translator(string text)
        {
            try
            {
                if (text.Length <= 100)
            ...
            {
                return "Sorry, Aether couldn't find the requested languages";
            }
            return "Sorry, Aether couldn't find some suitable translation.";
        } 
